...
public class Encrypt {
    public static String getEncryptString(String encryptString, int shift) {
        ...
        // в цикле перебираем все символы из которых состоит переданная в метод строка, прибавляем к ним число, ключ (сдвиг)
    ...
    public static void main(String[] args) {
        ...
        String encrypted = getEncryptString(original, shift);
